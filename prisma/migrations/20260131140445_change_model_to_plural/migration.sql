/*
  ...
  - You are about to drop the `LocationTag` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "CollectionItem" DROP CONSTRAINT "CollectionItem_locationId_fkey";
